...
const SearchInput = ({ placeholder = "", value = "", onChange, name = "" }) => {
    ...
    return (require$$0__default["default"].createElement("div", { className: classNames && classNames.searchContainer
        ...
        require$$0__default["default"].createElement("input", { className: "w-full py-2 text-sm text-gray-500 bg-gray-100 border border-gray-200 rounded focus:border-gray-200 focus:ring-0 focus:outline-none focus:outline-none focus:border-lightGreen focus:outline-none focus:ring-primary-50", type: "text", placeholder: placeholder, value: value, onChange: onChange, name: name })));
};
