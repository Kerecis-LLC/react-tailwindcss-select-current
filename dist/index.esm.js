...
const Options = ({ list, noOptionsMessage, text, isMultiple, value, primaryColor = DEFAULT_THEME }) => {
    ...
    return (require$$0.createElement("div", { role: "options", className: classNames && classNames.list ? classNames.list : "h-32 overflow-y-scroll" },
        filterResult.slice(0, 100).map((item, index) => (require$$0.createElement(require$$0.Fragment, { key: index }, "options" in item ? (require$$0.createElement(require$$0.Fragment, null,
...
const SearchInput = ({ placeholder = "", value = "", onChange, name = "" }) => {
    ...
    return (require$$0.createElement("div", { className: classNames && classNames.searchContainer
        ...
        require$$0.createElement("input", { className: "w-full py-2 text-sm text-gray-500 bg-gray-100 border border-gray-200 rounded focus:border-gray-200 focus:ring-0 focus:outline-none focus:outline-none focus:border-lightGreen focus:outline-none focus:ring-primary-50", type: "text", placeholder: placeholder, value: value, onChange: onChange, name: name })));
};
    ...
    return (require$$0.createElement(SelectProvider, { otherData: {
        ...
        require$$0.createElement("div", { className: "relative w-full mt-1", ref: ref },
            require$$0.createElement("div", { tabIndex: 0, "aria-expanded": open, onKeyDown: onPressEnterOrSpace, onClick: toggle, className: "bg-white cursor-default rounded-lg text-left border outline-16 border-lightGreen px-3 placeholder-primary-500 shadow-sm focus:border-lightGreen focus:outline-none focus:ring-primary-500 sm:text-sm flex" },
                require$$0.createElement("div", { className: "grow pl-2.5 py-2 pr-2 flex flex-wrap gap-1 w-1/2" }, !isMultiple ? (require$$0.createElement("p", { className: "truncate cursor-default select-none" }, value && !Array.isArray(value) ? value.label : placeholder)) : (require$$0.createElement(require$$0.Fragment, null,
